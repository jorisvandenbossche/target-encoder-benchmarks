...
def file_meet_conditions(files, conditions):
    '''Return:
    ...
    for f in files:
        ...
        for key in conditions:
            ...
            elif key == 'reduction_method':
                cond = (params['dimension_reduction'][0] == conditions[key])
            elif key == 'n_components':
                cond = (params['dimension_reduction'][1] == conditions[key])
            elif key == 'dataset':
